...
export function DrillCard(): JSX.Element {
        ...
        const drill = {
          ...
          description: 'מתחילים במצב עמידה באחיזה Low Ready, לאחר התקלה משחררים שני כדורים במצב כריעה אל עבר המטרה השמאלית, לאחר מכן חוזרים למצב עמידה.יש לבצע עבור שלוש המטרות.',
        };
