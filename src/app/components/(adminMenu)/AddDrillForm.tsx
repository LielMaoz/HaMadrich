...
const formSchema = z.object({
  training_name: z.string().min(1).max(255),
  drill_type: z.string().max(50),
  weapon_type: z.string().max(50),
  ...
  range_img: z.instanceof(File).refine(
        ...
        <Form {...form}>
          <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-8 max-w-3xl mx-auto py-10" >
            ...
            <AlertDialogFooter className="gap-2">
              ...
              <AlertDialogAction type="submit">הוסף</AlertDialogAction>
            </AlertDialogFooter> 
          </form>
        </Form>
